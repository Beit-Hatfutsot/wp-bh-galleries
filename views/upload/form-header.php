...
<div class="form-header">
	...
	<div class="step-indicator-wrap">
		<?php if ( $step_indicator ) : ?>
			<span class="step-indicator step-indicator1 active"><?php printf( $step_indicator, '1', '3' ); ?></span>
			<span class="step-indicator step-indicator2"><?php printf( $step_indicator, '2', '3' ); ?></span>
			<span class="step-indicator step-indicator3"><?php printf( $step_indicator, '3', '3'); ?></span>
		<?php endif; ?>
	</div>
